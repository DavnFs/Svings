            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Start managing your finances', style: TextStyle(color: AppColor.textSecondary, fontSize: 15)),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    const Text('Already have an account? ', style: TextStyle(color: AppColor.textSecondary, fontSize: 14)),
                    GestureDetector(
                      onTap: () => Get.back(),
                      child: const Text('Sign In', style: TextStyle(color: AppColor.accent, fontWeight: FontWeight.w600, fontSize: 14)),
                    ),
                  ]),
                ],
              ),
